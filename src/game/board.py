...
class Board(arcade.Window):
    ...
    def setup(self):
        ...
        self.menu = Menu(menu_center, colors.LIGHT_GRAY, MENU_WIDTH, MENU_HEIGHT)
        ...
        for hex in self.tiles:
            self.shapes_list.append(hex._shape)
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        match button:
            ...
            case 4:
                ...
                # action.
                if (
                    self.start_tile is not None
                    and self.start_tile[0] != -1
                    and self.curr_tile[0] != -1
                    and self.start_tile != self.curr_tile
    ...
    def get_neightbours(self, coords: Coords) -> list[Point]:
        x, y = coords
