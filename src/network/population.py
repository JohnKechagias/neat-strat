...
class Population:
    ...
    def run(self, fitness_function, n=None):
        ...
        while n is None or k < n:
            ...
            representatives = self.get_species_representatives()
            print(f"Population: {len(self.population)}")
            print(f"Species: {len(self.species.species)}")
            print(f"Representatives: {len(representatives)}\n")
            # Evaluate all genomes using the user-provided function.
            fitness_function(
                list(iteritems(self.population)),
                self.config,
                representatives,
            )
    ...
    def get_species_representatives(self) -> list[DefaultGenome]:
        representatives: list[DefaultGenome] = []
        for species in self.species.species.values():
            representatives.append(species.representative)
